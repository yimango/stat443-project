...
tryCatch({
  ...
  message("  ", e$message)
  message("\nBut the column fix was successful! You can now manually run:")
  message("  source('Evaluation/evaluate_models.R', local = TRUE)")
  message("  result$evaluation <- evaluate_all_models(result$backtest_results, output_dir = 'outputs')")
})
